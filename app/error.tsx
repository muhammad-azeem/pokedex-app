    ...
    <main className="flex min-h-screen flex-col items-center justify-center gap-6 bg-gray-50 px-4 text-center dark:bg-gray-900">
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-500 dark:text-gray-400">
          We couldn&apos;t load the Pokédex data. The API might be down.
        </p>
        {process.env.NODE_ENV === "development" && (
          <p className="rounded-lg bg-red-50 px-4 py-2 text-sm font-mono text-red-600 dark:bg-red-900/30 dark:text-red-400">
            {error.message}
          </p>
        )}
      </div>
